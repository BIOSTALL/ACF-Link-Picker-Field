		...
		*/
		...
		<div id="link-picker-<?php echo $field['id']; ?>-wrap">
            <p>
                ...
                <input type="hidden" name="<?php echo $field['name']; ?>[target]" id="link-picker-<?php echo $field['id']; ?>-target" value="<?php echo ( isset($field['value']['target']) ) ? $field['value']['target'] : ''; ?>">
                
                <div id="link-picker-<?php echo $field['id']; ?>-exists"<?php if (!$exists) { echo ' style="display:none;"'; } ?>>
                    <?php _e('URL', 'acf-link_picker') ?>: <em id="link-picker-<?php echo $field['id']; ?>-url-label"><a href="<?php echo $field['value']['url']; ?>" target="_blank"><?php echo $field['value']['url']; ?></a></em><br>
                    <?php _e('Title', 'acf-link_picker') ?>: <em id="link-picker-<?php echo $field['id']; ?>-title-label"><?php echo $field['value']['title']; ?></em><br>
                    <?php _e('Open in new window', 'acf-link_picker') ?>: <em id="link-picker-<?php echo $field['id']; ?>-target-label"><?php if (isset($field['value']['target']) && $field['value']['target'] == '_blank') { _e('Yes', 'acf-link_picker'); } else { _e('No', 'acf-link_picker'); } ?></em>
                </div>
